...
def run():
    ...
    window = sdl2.SDL_CreateWindow(b"OpenGL Cone",
...
def draw(window):
    ...
    while handle_events():
        ...
        mouse_rotation(mouse_x, mouse_y, lambda: draw_cone(100, 100, math.floor(mouse_x.value / 10) + 1))
...
def draw_cone(radius = 100, size = 100, sides_number = 6):
